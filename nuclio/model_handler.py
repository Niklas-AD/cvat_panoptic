...
class ModelHandler:
    def __init__(self, labels):
        ...
        print(os.getcwd())
        cfg.merge_from_file("Mask2Former/configs/cityscapes/panoptic-segmentation/maskformer2_R50_bs16_90k.yaml") #Masterarbeit/Mask2Former/configs/cityscapes/panoptic-segmentation/maskformer2_R50_bs16_90k.yaml
